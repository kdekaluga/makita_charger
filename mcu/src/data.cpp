...
{
    int16_t voltage = static_cast<int16_t>((utils::ShiftLeft12(x1000Voltage) + 12000)/m_voltage4096Value) -
...
{
    int16_t current = static_cast<int16_t>((utils::ShiftLeft12(x1000Current) + 6000)/m_current4096Value) -
