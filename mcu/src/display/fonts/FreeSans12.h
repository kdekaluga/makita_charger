...
namespace display::FreeSans12 {

const Glyph g_glyphs[] PROGMEM =
{
    {0, 0, 0, 6, 0, 1},         // 0x20 ' '
    {0, 2, 18, 8, 3, -17},      // 0x21 '!'
    {5, 6, 6, 8, 1, -16},       // 0x22 '"'
    ...
    // Additional symbols
    {0, 0, 0, 13, 0, 1},        // 0x7F ' ' (Wide space, with a digit's width)
    {1969, 8, 7, 14, 3, -16},   // 0x80 (degree sign)
};

// Approx. 2641 bytes
const Font g_font PROGMEM =
{
    g_glyphs, 0x80, 0x20, -21, 27,
    {
...
} // namespace display::FreeSans18pt
